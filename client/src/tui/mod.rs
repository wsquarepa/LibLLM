...
use libllm::session::{Message, NodeId, Role, SaveMode, Session, SessionEntry};
...
struct App<'a> {
    ...
    worldbook_editor_entries: Vec<libllm::worldinfo::Entry>,
    worldbook_editor_original_entries: Vec<libllm::worldinfo::Entry>,
