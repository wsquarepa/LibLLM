...
use crate::App;
use crate::types::{DangerOp, DangerSummary, StatusLevel};

pub(crate) fn spawn_destroy_all(
    bg_tx: tokio::sync::mpsc::Sender<crate::types::BackgroundEvent>,
...
pub(crate) fn handle_op_complete(
    app: &mut App,
    op: DangerOp,
...
pub(crate) fn dispatch_sync(app: &mut App, op: DangerOp) -> Result<DangerSummary> {
...
pub(crate) fn report_summary(app: &mut App, op: DangerOp, summary: &DangerSummary) {
