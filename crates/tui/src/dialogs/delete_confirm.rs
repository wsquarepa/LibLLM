...
use crate::{Action, App, DeleteContext, Focus, business, maintenance};
...
pub(crate) fn handle_confirm_key(key: KeyEvent, selected: &mut usize) -> ConfirmResult {
    match key.code {
...
pub(crate) fn render_delete_confirm_dialog(f: &mut ratatui::Frame, app: &App, area: Rect) {
        ...
        ConfirmResult::Confirmed => {
            ...
            match context {
                ...
                DeleteContext::ThemeResetColors => {
                    ...
                    crate::dialog_handler::live_apply_theme_dialog(app);
