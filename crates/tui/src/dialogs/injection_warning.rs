...
pub(crate) const INJECTION_WARNING_DIALOG_WIDTH: u16 = 72;
pub(crate) const INJECTION_WARNING_DIALOG_HEIGHT: u16 = 11;
...
pub(crate) fn open(app: &mut App<'_>, path: &std::path::Path, kind: libllm::files::DelimiterKind) {
    ...
    app.focus = crate::Focus::InjectionWarningDialog;
}
