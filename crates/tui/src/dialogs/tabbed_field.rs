...
use crate::render::{centered_rect, clear_centered, dialog_block, render_hints_below_dialog};
...
impl<'a> TabbedFieldDialog<'a> {
    ...
    pub fn sections_mut(&mut self) -> &mut [TabSection] {
        &mut self.sections
    }
    ...
    fn open_multiline_editor(&mut self) {
        ...
        crate::dialog_handler::configure_textarea_at_start(&mut editor);
