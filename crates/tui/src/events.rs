...
pub(crate) fn format_at_token(path: &str) -> Option<String> {
    if path.contains('"') {
        return None;
    }
        ...
        Action::UnsavedWarningResolved(button) => {
            ...
            match (return_focus, button) {
                (Focus::ConfigDialog, UnsavedButton::SaveAndClose) => {
                    crate::dialog_handler::commit_config_dialog(app);
                }
                (Focus::ConfigDialog, UnsavedButton::Discard) => {
                    crate::dialog_handler::discard_config_dialog(app);
                }
                (Focus::ThemeDialog, UnsavedButton::SaveAndClose) => {
                    crate::dialog_handler::commit_theme_dialog(app);
                }
                (Focus::ThemeDialog, UnsavedButton::Discard) => {
                    crate::dialog_handler::discard_theme_dialog(app);
                }
                ...
                (Focus::PresetEditorDialog, UnsavedButton::SaveAndClose) => {
                    let _ = crate::dialog_handler::commit_field_dialog(
                        app,
                        crate::dialog_handler::DialogKind::PresetEditor,
                    );
                }
                (Focus::PresetEditorDialog, UnsavedButton::Discard) => {
                    crate::dialog_handler::discard_field_dialog(
                        app,
                        crate::dialog_handler::DialogKind::PresetEditor,
                    );
                }
                (Focus::PersonaEditorDialog, UnsavedButton::SaveAndClose) => {
                    let _ = crate::dialog_handler::commit_field_dialog(
                        app,
                        crate::dialog_handler::DialogKind::PersonaEditor,
                    );
                }
                ...
                (Focus::AuthorNoteEditorDialog, UnsavedButton::SaveAndClose) => {
                    let _ = crate::dialog_handler::commit_field_dialog(
                        app,
                        crate::dialog_handler::DialogKind::AuthorNoteEditor,
                    );
                }
                ...
                (Focus::CharacterEditorDialog, UnsavedButton::SaveAndClose) => {
                    let _ = crate::dialog_handler::commit_field_dialog(
                        app,
                        crate::dialog_handler::DialogKind::CharacterEditor,
                    );
                }
                ...
                (Focus::SystemPromptEditorDialog, UnsavedButton::SaveAndClose) => {
                    let _ = crate::dialog_handler::commit_field_dialog(
                        app,
                        crate::dialog_handler::DialogKind::SystemPromptEditor,
                    );
                }
                ...
                (Focus::WorldbookEntryEditorDialog, UnsavedButton::SaveAndClose) => {
                    let _ = crate::dialog_handler::commit_field_dialog(
                        app,
                        crate::dialog_handler::DialogKind::WorldbookEntryEditor,
                    );
                }
