...
pub const COMMANDS: &[CommandInfo] = &[
    ...
    CommandInfo { name: "/character", args: "[import <path>]", description: "Select a character or import a card" },
    CommandInfo { name: "/self", args: "", description: "Set your name and persona" },
    CommandInfo { name: "/worldbook", args: "", description: "Toggle worldbooks for this session" },
